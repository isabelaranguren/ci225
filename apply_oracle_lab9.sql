...
-- Verify completion of this step:
...
-- Create the ACCOUNT_LIST table and ACCOUNT_LIST_S1 sequence.

CREATE TABLE account_list
( account_list_id        NUMBER 
, account_number         VARCHAR2(10) CONSTRAINT nn_alist_1 NOT NULL
, consumed_date          DATE         
, consumed_by            NUMBER      
, created_by             NUMBER       CONSTRAINT nn_alist_2 NOT NULL
, creation_date          DATE         CONSTRAINT nn_alist_3 NOT NULL
, last_updated_by        NUMBER       CONSTRAINT nn_alist_4 NOT NULL
, last_update_date       DATE         CONSTRAINT nn_alist_5 NOT NULL
